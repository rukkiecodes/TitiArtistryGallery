    ...
    <v-container>
        <v-card width="600" class="mx-auto" flat="">
            ...
            <v-card-title class="d-flex">
                <span>
                    ...
                    <v-dialog v-model="titleDialog" activator="parent" width="400">
                        <v-card rounded="lg">
                            <v-card-text>
                                <v-text-field variant="underlined" label="Post title" v-model="gallery.title"
            ...
            <v-dialog v-model="bodyDialog" width="400" scrollable>
                <v-card rounded="lg">
                    <v-card-text>
                        <v-textarea v-model="gallery.body" label="What would you like to say about this image" rows="3"
                            max-rows="8" variant="underlined" color="indigo-darken-2" />
                    </v-card-text>
